    ...
    <div>
      {questions.length > 0 && currentQuestionIndex < questions.length ? (
        <div className='py-2 flex flex-col justify-center items-center'>
          ...
          <div className='bg-[#9AD0C2] w-2/3 md:w-1/4 h-[100px] md:h-[125px] p-2 flex flex-col justify-center items-center rounded-md'>
        ...
        <div className='flex flex-col items-center'>
          ...
          <button
            className='bg-[#2D9596] hover:bg-[#39BCBD] rounded p-4 w-24 mb-72'
